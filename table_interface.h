...
public:
    ...
    virtual std::shared_ptr<const answer> get_with_limit(std::function<bool(const object&)> where, size_t start, size_t limit) = 0;
    ...
    virtual void unlock_record(OID oid) = 0; 
